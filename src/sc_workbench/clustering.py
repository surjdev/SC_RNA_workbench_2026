...
def cluster_leiden(
    ...
    console.print(f"[bold cyan]Clustering cells with Leiden (resolution={resolution})...[/bold cyan]")
    sc.tl.leiden(
        adata,
    ...
    console.print(f"[bold green]✔ Leiden clustering complete:[/bold green] Discovered [magenta]{n_clusters}[/magenta] clusters.")
    return adata
...
def cluster_louvain(
    ...
    console.print(f"[bold cyan]Clustering cells with Louvain (resolution={resolution})...[/bold cyan]")
    sc.tl.louvain(
        adata,
        resolution=resolution,
        key_added=key_added,
    ...
    n_clusters = len(adata.obs[key_added].unique())
    console.print(f"[bold green]✔ Louvain clustering complete:[/bold green] Discovered [magenta]{n_clusters}[/magenta] clusters.")
    return adata
...
def subcluster(
    ...
    console.print(f"[bold cyan]Sub-clustering cluster '{parent_cluster}' (resolution={resolution})...[/bold cyan]")
    ...
    console.print(f"[bold green]✔ Sub-clustering complete (saved in .obs['{new_key}']).[/bold green]")
    return adata
...
def cluster_sklearn(
    ...
    console.print(f"[bold cyan]Clustering cells using Scikit-Learn [yellow]{est_name}[/yellow] on [magenta]{use_rep}[/magenta]...[/bold cyan]")
    ...
    console.print(f"[bold green]✔ Scikit-Learn ({est_name}) clustering complete:[/bold green] Discovered [magenta]{n_clusters}[/magenta] clusters (stored in .obs['{key_added}']).")
    return adata
