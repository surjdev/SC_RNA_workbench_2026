...
def normalize_and_log(
    ...
    """
    console.print(f"[bold cyan]Normalizing counts to {target_sum:,.0f} and computing log1p...[/bold cyan]")
...
def select_hvg(
    ...
    """
    console.print(f"[bold cyan]Selecting top {n_top_genes} Highly Variable Genes (flavor={flavor})...[/bold cyan]")
    ...
    console.print(f"[bold green]✔ HVG Selection:[/bold green] Identified [yellow]{n_hvg}[/yellow] highly variable genes.")
    return adata
